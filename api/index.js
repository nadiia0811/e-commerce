...
app.use(cors()); 
  ...
  mongoose.connect("mongodb+srv://nadiia1985:kolibri85@cluster0.n0adgsa.mongodb.net/e-commerce")
...
app.get('/newcollection', async (req, res) => {
    let products = await Product.find({});
    let newCollection = products.slice(1, 4).concat(products.slice(13, 16)).concat(products.slice(23, 25))
...
//creaing endpoint to adding products to cart
